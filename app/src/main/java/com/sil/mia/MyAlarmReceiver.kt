...
class MyAlarmReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        CoroutineScope(Dispatchers.IO).launch {
            ...
            Log.i("AudioRecord", "MyAlarmReceiver onReceive wakePayload: $wakePayload")
            val wakeResponse = callingAPIs.callOpenaiAPI(wakePayload)
            Log.i("AudioRecord", "MyAlarmReceiver onReceive wakePayload: $wakeResponse")
    ...
    private fun createSystemPrompt(context: Context): String {
        ...
        return """
            ...
            Context:
        """.trimIndent() + messageArray.toString()
    }
